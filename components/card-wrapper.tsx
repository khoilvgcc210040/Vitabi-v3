  ...
  return (
    <div className="flex justify-center items-start bg-white">
      ...
      <div className="flex flex-col border max-w-md w-full bg-white min-h-[720px] sm:min-h-[695px] flex-grow" style={{ border: '2px solid #999' }}>
        ...
        <footer className="flex justify-around w-full py-4" style={{ marginTop: 'auto', borderTop: '2px solid #999' }}>
          <Link href="/" className="nav-link flex flex-col items-center" style={{ width: '70px' }}>
          ...
          <Link href="/bookings" className="nav-link flex flex-col items-center" style={{ width: '70px' }}>
          ...
          <Link href="/mydata" className="nav-link flex flex-col items-center" style={{ width: '70px' }}>
