...
const EditDistanceInfo = () => {
  ...
  useEffect(() => {
    if (searchParams) {
      // Populate data from search params
      const hospital = searchParams.get("hospital") || "";
      const distanceText = searchParams.get("distanceText") || "";
      const durationText = searchParams.get("durationText") || "";
      setFormData({ hospital, distanceText, durationText });
    }
  }, [searchParams]);
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-md">
      <h1 className="text-3xl font-bold mb-6">Edit Distance Info</h1>
...
export default EditDistanceInfo;
